...
void send_and_receive_message(int sock, const std::string &message) {
  ...
  // We can use received_buffer as that is more clear and appropriate
...
//right now we only take the first string. But the user may have wanted an entire sentence. 
